...
class Navigation:
    ...
    def a_star_path_planner(self,start_pose,end_pose):
        ...
        # Setting the start node and end node in the graph using the start and end poses
        mp.map_graph.root = "{}, {}".format(int(102 + 10*start_pose.pose.position.x), int(94 - 10*start_pose.pose.position.y))
        mp.map_graph.end = "{}, {}".format(int(102 + 10*end_pose.pose.position.x), int(94 - 10*end_pose.pose.position.y))
