...
(cl:defmethod cl:initialize-instance :after ((m <distance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'distance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aut_sys-msg:<distance> is deprecated: use aut_sys-msg:distance instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <distance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aut_sys-msg:distance-val is deprecated.  Use aut_sys-msg:distance instead.")
  (distance m))
